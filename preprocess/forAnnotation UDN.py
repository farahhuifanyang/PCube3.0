...
LastEditTime: 2021-03-07 14:48:36
...
def statistics():
    years = {}
    topics = {}
    root = "/home/disk2/nuclear/news_data/PCube/UDN"
...
def randomSample():
    root = "/home/disk2/nuclear/news_data/PCube/UDN/UDN/"
    inputpaths = []
    filemap = {}
    for year in os.listdir(root):
        yeardir = root + year
        ...
        for topic in os.listdir(yeardir):
            topicdir = yeardir + "/" + topic
            if not os.path.isdir(topicdir) or topic == "Oops":
                continue
            for file in os.listdir(topicdir):
    ...
    for inputpath in inputpaths:
        ...
        outpath = f"/home/disk2/nuclear/PCubeAnn/UDNAnnImport/{name}.txt"
        try:
    ...
    with open("/home/nuclear/PCube3/static/preproces/UDNAnnFileMap.json", "w") as wf:
